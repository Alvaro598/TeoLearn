    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="max-w-6xl mx-auto px-6 py-10 grid md:grid-cols-2 lg:grid-cols-3 gap-5">
        {filteredVideos.map((video) => (
          <article key={video.title} className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
            ...
            <div className="p-5">
              ...
              <p className="text-sm text-gray-600 leading-relaxed mb-5">{video.description}</p>
